...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to four some store.</h1>
  ...
  <div class="container__child signup__form">
    <form action="{{url('register-save')}}" method="POST">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="username" id="username" placeholder="dat.vip" required />
      </div>
      <div class="form-group">
        <label for="email">Email</label>
        <input class="form-control" type="text" name="email" id="email" placeholder="datdeptrai@gmail.com" required />
      </div>
      <div class="form-group">
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
            <input class="btn btn--form" herf="" type="submit" value="Register" />
          </li>
          <li>
