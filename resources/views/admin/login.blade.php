...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Spectre sign up form</title>
  <meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css">
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.min.css'>
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,300'>
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Roboto:400,700,300'>
<link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css'><link rel="stylesheet" href="../customer/style.css">
</head>
<body>
...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to Four Some.</h1>
  ...
  <div class="container__child signup__form">
    <form action="{{route('admin-processlogin')}}" method="POST">
      ...
      <div class="form-group">
        ...
        <input class="form-control"  type="text" id="username" name="username" id="username" placeholder="dat.vip" required />
      </div>
      <div class="form-group">
        <label for="password">Password</label>
        <input class="form-control" type="password" id="password" name="password" id="password" placeholder="********" required />
      </div>
      <div class="m-t-lg">
        <ul class="list-inline">
            
          <li>
            <a class="signup__link" >Forgot Password</a>
          </li>
        </ul>
      </div>
      <div class="form-group">
